...
# evaluation
python ./discogan/evaluation.py --image_dir ./datasets/celeba/celeba_demo --attr_file ./datasets/celeba/list_attr_celeba_demo.txt --n_test 10 --task_name celebA --style_A Male --batch_size 1 --ckpt_path ./datasets/ckpts/discoGAN20000.pdparams
