...
class CelebaDataset(Dataset):
    def __init__(self, img_dir, attr_file, image_size=64, style_A='Male', style_B=None,
        ...
        self.style_A_paths, self.style_B_paths = self.get_celebA_files()

        self.style_A_imgs = read_images(filenames=self.style_A_paths, image_size=self.image_size)
        self.style_B_imgs = read_images(filenames=self.style_B_paths, image_size=self.image_size)
